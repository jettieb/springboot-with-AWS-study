...
//HelloControllerTest에서 사용한 WebMvcTest는 jpa 테스트에 사용 못함.
public class PostsApiControllerTest {
    ...
    public void Posts_등록된다() throws Exception{
        ...
        //restTemplate.postForEntity : post 요청을 할 때 사용
        // dto를 별도로 감싸지 않고 바로 DTO로 넣을 수 있음.
    ...
    public void Posts_수정된다() throws Exception{
        ...
        //restTemplate.exchange : PUT, GET, DELETE 등 다양한 HTTP 메서드를 처리할 수 있는 메서드
        //HttpEntity로 요청을 감싸서 전송해야함.
